...
window.CH[6] = {
  levels: [
    ...
    /* ---------- L5 · Expert ---------- */
    { html:
      '<div class="diagram-block"><pre class="arch-diagram">┌──────────────────────────────────────────────────────────────┐\n│                   ZERO-TRUST REQUEST FLOW                    │\n├──────────────────────────────────────────────────────────────┤\n│  Principle: "Never trust the network; always verify."        │\n│                                                              │\n│  [Service A] --> [Identity-Aware Proxy / mTLS Gateway]      │\n│                         |                                    │\n│               +---------v----------+                         │\n│               | 1. Authenticate    | SPIFFE/OIDC identity   │\n│               | 2. Authorize       | OPA/Cedar policy       │\n│               | 3. Encrypt transit | Mutual TLS             │\n│               +---------+----------+                         │\n│                         | ALLOW                             │\n│                         v                                    │\n│                   [Service B]                                │\n│                                                              │\n│  Legacy "Castle and Moat": inside VPC = trusted  WRONG!     │\n│  Zero-Trust: inside VPC still must authenticate  RIGHT!     │\n│                                                              │\n│  Tools: BeyondCorp, SPIFFE/SPIRE, Istio AuthPolicy          │\n└──────────────────────────────────────────────────────────────┘\n</pre></div><p>At expert level, zero trust is a <b>migration strategy</b>, not a switch you flip — you cannot authenticate every request on day one ' +
