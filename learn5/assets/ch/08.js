...
window.CH[8] = {
  levels: [
    ...
    /* ---------- L5 · Expert ---------- */
    { html:
      '<div class="diagram-block"><pre class="arch-diagram">┌──────────────────────────────────────────────────────────────┐\n│            INCIDENT LIFECYCLE (PagerDuty / Opsgenie)         │\n├──────────────────────────────────────────────────────────────┤\n│  Prometheus alert --> Alertmanager --> PagerDuty page       │\n│       |                                                      │\n│  1. DETECT: On-call acknowledges  (P1 SLA: 5 min ack)       │\n│       |                                                      │\n│  2. TRIAGE: Assign severity:                                 │\n│     P1 Revenue/safety impact --> war room immediately       │\n│     P2 Degraded service      --> resolve within 4h          │\n│     P3 Minor / low impact    --> next business day           │\n│       |                                                      │\n│  3. ESCALATE: Page domain experts if stuck                  │\n│       |                                                      │\n│  4. MITIGATE: Rollback / feature flag / circuit break       │\n│       |                                                      │\n│  5. RESOLVE: All metrics green; close PagerDuty alert       │\n│       |                                                      │\n│  6. POSTMORTEM: Blameless 5-whys document within 48h       │\n│     Action items tracked to completion (Jira/Linear)        │\n└──────────────────────────────────────────────────────────────┘\n</pre></div><p>Incident command is a communication protocol disguised as an org chart — its entire value is removing ambiguity about who decides and who ' +
