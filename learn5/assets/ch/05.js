...
window.CH[5] = {
  levels: [
    ...
    /* ---------- L5 · Expert ---------- */
    { html:
      '<div class="diagram-block"><pre class="arch-diagram">┌──────────────────────────────────────────────────────────────┐\n│                 SLO / ERROR BUDGET FRAMEWORK                 │\n├──────────────────────────────────────────────────────────────┤\n│  SLI: Availability = good_requests / total_requests          │\n│  SLO: Availability >= 99.9% (30-day rolling window)         │\n│  Error Budget: 100% - 99.9% = 0.1% = 43.2 min/month        │\n│                                                              │\n│  MULTI-WINDOW BURN RATE ALERTS:                              │\n│  +-----------------+------------+-------------------------+  │\n│  | Burn Rate       | Window     | Action                  |  │\n│  +-----------------+------------+-------------------------+  │\n│  | 14.4x           | 1 hour     | Page on-call NOW        |  │\n│  | 6x              | 6 hours    | Ticket + Slack          |  │\n│  | 3x              | 3 days     | Weekly review           |  │\n│  +-----------------+------------+-------------------------+  │\n│                                                              │\n│  Budget exhausted? Feature freeze + reliability sprint      │\n│                                                              │\n│  KEY: Alert on burn RATE (not raw error %) to catch         │\n│  both fast incidents and slow-burn reliability failures     │\n└──────────────────────────────────────────────────────────────┘\n</pre></div><p>Log aggregation is the signal most likely to blow the observability budget, because it is the easiest to over-collect — "just log ' +
