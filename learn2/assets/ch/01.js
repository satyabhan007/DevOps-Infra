...
window.CH[1] = {
  levels: [
    ...
    /* ---------- L5 · Expert ---------- */
    { html:
      '<div class="diagram-block"><pre class="arch-diagram">┌──────────────────────────────────────────────────────────────┐\n│            TERRAFORM MODULE COMPOSITION PATTERN              │\n├──────────────────────────────────────────────────────────────┤\n│  environments/prod/main.tf  (Root Module)                    │\n│  |                                                           │\n│  |-> module "network" {                                      │\n│  |       source   = "../../modules/vpc"                      │\n│  |       cidr     = "10.0.0.0/16"                           │\n│  |       az_count = 3                                        │\n│  |   }                                                       │\n│  |                                                           │\n│  |-> module "eks" {                                          │\n│  |       source  = "../../modules/eks"                       │\n│  |       vpc_id  = module.network.vpc_id   # output ref     │\n│  |       subnets = module.network.private_subnets            │\n│  |   }                                                       │\n│  |                                                           │\n│  +-> module "rds" {                                          │\n│          source     = "../../modules/rds"                    │\n│          subnet_ids = module.network.data_subnets            │\n│      }                                                       │\n│                                                              │\n│  Always PIN module versions:                                 │\n│  source = "git::https://...?ref=v2.1.0"  -- never @latest  │\n└──────────────────────────────────────────────────────────────┘\n</pre></div><p>At expert level, module design is an <b>API design</b> problem: the module\'s variables and outputs are a contract, and every caller is a ' +
